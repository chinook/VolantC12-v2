...
public:
    ...
    virtual void update_debug_log_1_value(float debug_log_1_value);
    virtual void update_debug_log_2_value(float debug_log_2_value);
    virtual void update_debug_log_3_value(float debug_log_3_value);
    virtual void update_debug_log_4_value(float debug_log_4_value);
